...
|ORICO Type-C -> USB3.0×7 Hub（带供电）|1|￥42.4|5Gbps|
|40×20×3mm硅胶脚垫|4|￥10|发6个|
|希捷硬盘盒裸板易驱线（送数据线）|6|￥50|主控JMS577泰国产，只适配了两款，[点这里查看型号样式](#%E6%94%AF%E6%8C%81%E7%9A%84%E4%B8%A4%E7%A7%8D%E5%9E%8B%E5%8F%B7%E7%9A%84%E8%A3%B8%E6%9D%BF)|
|Type-C公头带软排线|2|￥14|
...
## 总成本
 ...
 打印件成本￥64.8 + 采购件成本￥685.2 + 存储成本￥480 \~ 2370 = ￥1230 \~ 3120
...
<h2 align="center">自制热插拔背板成本低至30.9%</h2>
...
> ⚠ **注意：实测只加1块硬盘可以使用无供电hub，主板输入5V3A即可，部分hub不加供电能支持到2块硬盘（飞利浦不支持，深圳同创支持，可能和hub本身耗电有关）**
...
- 目前没有合适小尺寸或7口的USB 3.1 hub，暂用单个7口USB 3.0 hub（5Gbps|625 MB/s）
  - 6块盘如果全配3 TB蓝盘（100MB/s每块）（3.0 hub满速） + 1块SSD接3.1 hub
  - 如果配置有黑盘（能到150MB/s每块），最多
    - 2块黑盘+3块3 TB蓝盘（3.0 hub满速） + 1块SSD接3.1 hub
    - 4块黑盘（3.0 hub满速） + 1块SSD、1块3 TB蓝盘接3.1 hub（3.1 hub满速，蓝盘可能供电不足）
